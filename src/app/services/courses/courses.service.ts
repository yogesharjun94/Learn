...
export class CoursesService {
  courses: Array<object> = [
    { title: 'Photoshop: effects', imageurl: '../../assets/img/photoshop.png', author: 'Tony Hammor',progress:'50%' },
    { title: 'Intro to Architecture', imageurl: '../../assets/img/architecture.jpg', author: 'Elisa Mittano',progress:'70%' },
    { title: 'Classic Literature', imageurl: '../../assets/img/classicenglish.png', author: 'Hemmingway' ,progress:'10%'},
